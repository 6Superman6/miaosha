...
public class Dxyarea {
    ...
    private String precent;             // 省确百分比

    private String supectedPercent;   // 省疑百分比

    private String curedPercent;      // 省治愈百分比

    private String deadPercent;       // 省死亡百分比
    ...
    public String getSupectedPercent() {
        return supectedPercent;
    }

    public void setSupectedPercent(String supectedPercent) {
        this.supectedPercent = supectedPercent;
    }

    public String getCuredPercent() {
        return curedPercent;
    }

    public void setCuredPercent(String curedPercent) {
        this.curedPercent = curedPercent;
    }

    public String getDeadPercent() {
        return deadPercent;
    }

    public void setDeadPercent(String deadPercent) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Dxyarea)) return false;

        Dxyarea dxyarea = (Dxyarea) o;

        return provinceName != null ? provinceName.equals(dxyarea.provinceName) : dxyarea.provinceName == null;
    }

    @Override
    public int hashCode() {
        return provinceName != null ? provinceName.hashCode() : 0;
    }
    ...
    public String toString() {
        return "Dxyarea{" +
                ...
                ", precent='" + precent + '\'' +
                ", supectedPercent='" + supectedPercent + '\'' +
                ", curedPercent='" + curedPercent + '\'' +
